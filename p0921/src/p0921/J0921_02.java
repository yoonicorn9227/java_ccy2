...
public class J0921_02 {
	...
	public static void main(String[] args) throws Exception {
		...
		// 학번 이음 국어 영어 수학 점수를 입력받아, 파일에 저장하시오.
		...
		while (true) {
			...
			System.out.println("[학   번]을 입력하세요.(0. 종료하려면 0번 입력)");
			int stuNum = scan.nextInt();
			if (stuNum == 0) {
				System.out.println("[프로그램 종료]");
				break;
			}
			System.out.println("[이   름]을 입력하세요.");
