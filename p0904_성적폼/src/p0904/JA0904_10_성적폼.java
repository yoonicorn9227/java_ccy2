...
public class JA0904_10_성적폼 {
	...
	public static void main(String[] args) {
		...
		case 3 :
			...
			break;
		case 4:
			System.out.println("[성적삭제]를 선택하셨습니다.");
			break;
		case 5 :
			System.out.println("[학생검색]을 선택하셨습니다.");
			break;
		case 6 :
			System.out.println("[등수처리]를 선택하셨습니다.");
			break;
		case 7 :
			System.out.println("[순차정렬]을 선택하셨습니다.");
			break;
		case 8 :
			System.out.println("[역순정렬]을 선택하셨습니다.");
			break;
